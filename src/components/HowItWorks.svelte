...
<div class="mb-8">
	<button
		class="flex w-full min-h-[48px] items-center justify-between rounded-xl px-5 py-3 text-left transition-all"
		style="
	...
	>
		<span class="text-sm font-bold" style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">
			How does AI write text?
		</span>
		<span
			class="text-xs transition-transform"
			style="color: var(--pv-text-muted); transform: rotate({expanded ? '180' : '0'}deg); transition-timing-function: var(--pv-ease-out);"
		>&#x25BC;</span>
	</button>

	{#if expanded}
		<div class="mt-2 rounded-xl px-5 pb-5 pt-4" style="background: var(--pv-surface)">
			{#if level === 'kids'}
				<div class="space-y-5 text-sm leading-relaxed" style="color: var(--pv-text-secondary)">
					<div class="flex gap-4">
						<span class="text-2xl">📚</span>
						<div>
							<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Step 1: The AI has read a LOT</strong>
					...
					<div class="flex gap-4">
						<span class="text-2xl">🎰</span>
						<div>
							<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Step 2: It picks the next word</strong>
					...
					<div class="flex gap-4">
						<span class="text-2xl">🔄</span>
						<div>
							<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Step 3: Repeat, repeat, repeat</strong>
					...
					<div class="flex gap-4">
						<span class="text-2xl">🎨</span>
						<div>
							<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Step 4: You control the creativity!</strong>
			...
			{:else if level === 'curious'}
				<div class="space-y-4 text-sm leading-relaxed" style="color: var(--pv-text-secondary)">
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Language models predict one token at a time.</strong>
					...
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Probability distribution:</strong>
					...
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Sampling:</strong>
					...
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Top-K and Top-P:</strong>
					...
					<div
						class="mt-1 rounded-lg p-3 text-xs"
						style="background: var(--pv-bg); color: var(--pv-accent)"
					>
			...
			{:else}
				<div class="space-y-4 text-sm leading-relaxed" style="color: var(--pv-text-secondary)">
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Autoregressive generation with logprobs.</strong>
					...
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Log probabilities:</strong>
					...
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Temperature scaling:</strong>
					...
					<p>
						<strong style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">Raw mode:</strong>
