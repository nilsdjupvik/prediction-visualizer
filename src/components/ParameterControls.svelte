...
<div class="mb-8">
	<div class="flex flex-wrap gap-x-8 gap-y-5">
		...
		<div class="min-w-52 flex-1">
			<div class="mb-2 flex items-center justify-between">
				<div class="flex items-center gap-2">
					<label for="temperature" class="text-sm font-semibold" style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">
					...
					<button
						...
						style="background: var(--pv-surface); color: var(--pv-text-muted); border: 1px solid var(--pv-border)"
						onclick={() => toggleTooltip('temperature')}
						aria-label="What is temperature?"
					>?</button>
				</div>
				<span class="tabular-nums text-xs font-medium" style="color: var(--pv-accent)">
					{level === 'kids' ? temperatureLabel(parameters.temperature) : parameters.temperature.toFixed(1)}
				</span>
			</div>
			{#if openTooltip === 'temperature'}
				<div class="mb-3 rounded-lg p-3 text-xs leading-relaxed" style="background: var(--pv-surface); color: var(--pv-text-secondary)">
		...
		<div class="min-w-52 flex-1">
			<div class="mb-2 flex items-center justify-between">
				<div class="flex items-center gap-2">
					<label for="topk" class="text-sm font-semibold" style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">
				...
				<span class="tabular-nums text-xs font-medium" style="color: var(--pv-accent)">{parameters.topK}</span>
			</div>
			{#if openTooltip === 'topK'}
				<div class="mb-3 rounded-lg p-3 text-xs leading-relaxed" style="background: var(--pv-surface); color: var(--pv-text-secondary)">
					{tooltips.topK[level]}
		...
		{#if level !== 'kids'}
			<div class="min-w-52 flex-1">
				<div class="mb-2 flex items-center justify-between">
					<div class="flex items-center gap-2">
						<label for="topp" class="text-sm font-semibold" style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">
					...
					<span class="tabular-nums text-xs font-medium" style="color: var(--pv-accent)">{parameters.topP.toFixed(1)}</span>
				</div>
				{#if openTooltip === 'topP'}
					<div class="mb-3 rounded-lg p-3 text-xs leading-relaxed" style="background: var(--pv-surface); color: var(--pv-text-secondary)">
						{tooltips.topP[level]}
		...
		{#if level !== 'kids'}
			<div class="min-w-52 flex-1">
				<div class="mb-2 flex items-center justify-between">
					<div class="flex items-center gap-2">
						<label for="numpredict" class="text-sm font-semibold" style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">
							Max words
						</label>
						<button
							class="inline-flex h-5 w-5 items-center justify-center rounded-full text-[10px] font-bold"
					...
					<span class="tabular-nums text-xs font-medium" style="color: var(--pv-accent)">{parameters.numPredict}</span>
				</div>
		...
		<div class="min-w-52 flex-1">
			<div class="mb-2 flex items-center justify-between">
				<div class="flex items-center gap-2">
					<label for="repeatpenalty" class="text-sm font-semibold" style="color: var(--pv-text-primary); font-family: var(--pv-font-display)">
